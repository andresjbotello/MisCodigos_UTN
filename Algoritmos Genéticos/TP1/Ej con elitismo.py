...
for c in range(n):
    ...
    cr[c+1][0]=str(bin(decord[0])[2:].zfill(30)) #Asigna a la siguiente generacion los dos valores mas altos
    ...
    for i in range (4): #crossover
        ...
        cr1h=str(bin(ru[cr1])[2:].zfill(30)) #Transforma contenido de ruleta en dicha posición a binario con 30 dígitos
