    ...
    while RELOJ < 5000:
        ...
        if minArribo < minPartida:
            ...
            if nroServer == 1:
                ...
                elif ListaArribos[2][0] == 99999:  # se da una sola vez
                    ListaArribos[2] = [RELOJ + np.random.exponential(server3.tm_entre_arribos), 3]
                    ListaArribos[3] = [RELOJ + np.random.exponential(server4.tm_entre_arribos), 4]
                    ListaArribos[4] = [RELOJ + np.random.exponential(server5.tm_entre_arribos), 5]
            elif nroServer == 2:
...
if __name__ == '__main__':
    ...
    # Ver el tema de que no genere un arribo en servidores 3,4 y 5 cuando la cola unica del medio está vacía.
