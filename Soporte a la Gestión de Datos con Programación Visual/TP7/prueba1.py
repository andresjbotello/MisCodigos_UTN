...
tree.insert("", 1, text="", values=("1","María Victoria","Massón"))
tree.insert("", 2, text="", values=("2","Andrés Julián","Botello","39366491"))
...
marco_botones.grid(row=10,columnspan=3,rowspan=1)
tk.Button(marco_botones,text="Alta").grid(ipadx=15,ipady=5,row=10,padx=20,pady=20,column=0)
tk.Button(marco_botones,text="Baja").grid(ipadx=15,ipady=5,row=10,padx=20,pady=20,column=1)
tk.Button(marco_botones,text="Modificación").grid(ipadx=10,ipady=5,row=10,padx=20,pady=20,column=2)
